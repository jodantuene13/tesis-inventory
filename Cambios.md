...
| 2026-03-08 | Antigravity AI | Módulo Inventario | Adición de acción "Ver Asociaciones" en listado de Atributos, mostrando las familias unidas a un atributo y permitiendo desvincularlas con advertencia de pérdida de datos. | Medio (Mejora UX/UI) |
| 2026-03-08 | Antigravity AI | Módulo Inventario | Implementación de regeneración automática de SKU de Productos al desvincular un atributo obligatorio de su familia. Integración de advertencia dinámica en el modal de Frontend. | Alto (Mejora Funcional y Consistencia) |
| 2026-03-26 | Antigravity AI | Módulo Inventario | Desarrollo del submenú Historial de Movimientos. Inclusión del campo CantidadRestante en movimientos, nuevos DTOs, endpoint GET y componente UI con filtros avanzados y Modal de Detalles. | Medio (Nueva Funcionalidad) |
| 2026-05-22 | Antigravity AI | UX Transversal — Mobile Responsive | Implementación de diseño responsive para todas las pantallas. Menú hamburguesa con drawer off-canvas animado en `AdminLayoutComponent`. Media queries globales para tablas, filtros, modales, formularios y KPI cards (breakpoints 768px y 1024px). Cierre automático del sidebar al navegar. | Alto (Mejora UX Mobile) |
